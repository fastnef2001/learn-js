...
//17. trimStart
//18. charAt
//19. sử dụng nhiều phương thức của string
...
//13. substr
     console.log(name3.substr(1, 5));     

console.log("-----------14.substring------------")
//14. substring
     console.log(name3.substring(1, 5));     

console.log("-----------15/16/17.trim/end/start------------")
//15. trim
...
console.log("-----------18.charAt------------")
//18. charAt
     console.log(name3.charAt(1));     

console.log("-----------19.sử dụng nhiều phương thức của string------------")     
//19. sử dụng nhiều phương thức của string
    console.log(name3.trim().replace("Quang", "Truong").toUpperCase().repeat(10))
