...
function timeSince(date){
    ...
    console.log(timer);
    if (timer >= 1) {
        console.log('${timer} năm trước 1');
    }
    timer = seconds / 2678400;
    if (timer >= 1) {
        console.log('${timer} tháng trước 2 ');
    }
    timer = seconds / 604800;
    if (timer >= 1) {
        console.log('${timer} tuần trước 3');
    }
    timer = seconds / 86400;
    if (timer >= 1) {
        console.log('${timer} ngày trước 4');
    }
    timer = seconds / 3600 ;
    if (timer >= 1) {
        console.log('${timer} ngày trước 5');
    }
    timer = seconds / 60;
    if (timer >= 1) {
    ...
    // if (timer < 1) {
    //     console.log("${timer} giây ");
    // }



}
timeSince("Mon May 23 2022 08:57:38 GMT+0700 (Indochina Time)")