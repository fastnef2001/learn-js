...
console.log(powerCase(string =322323));


console.log("-----------------------6.BT3 viết hàm có sử dụng callback (function là parameter của function khác) in ra kết quả của hàm--------------------")
function printMax(number){
    console.log(number)
}

function printCompare(a = 0, b = 0, callback ){
    const max = compare(a,b);
    callback(max);
}

console.log(printCompare(4,5,printMax))


console.log("-----------------------7.BT3 viết hàm có sử dụng callback (function là parameter của function khác) in ra kết quả của hàm--------------------")
