...
function getAge(year) {
    if(typeof year !== "number"){
        console.log("Bạn nhâpj ngày sinh chưa đúng")
    }
    const now = new Date();
    const currentYear = now.getFullYear();
    return currentYear - year;
}
const age = getAge(2001);
console.log(age);
...
console.log("---------BT3. viết chương trình có tên là timeSince, đầu vào là thời gian và tính thời gian đầu vào so với thời gian hiện tại-----");
